...
namespace Database.Migrations
{
    ...
    [Migration("20231107194437_Recreate_Schema_Financial")]
    partial class Recreate_Schema_Financial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProfileId = 1L,
                            Status = 1,
                            Uuid = new Guid("a3053bdc-74b5-4382-a57d-98e9b8a4948c")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Auth.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Admnistrador",
                            Status = 1,
                            Uuid = new Guid("7d26713a-314f-440a-8d49-4f1309a6dd95")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Fiancial.FinancialReleaseEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("FinancialReleaseType")
                        .HasColumnType("int");

                    b.Property<long?>("FinancialReleaseTypeEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FinancialReleaseTypeEntityId");
            ...
            modelBuilder.Entity("Domain.Entities.Fiancial.FinancialReleaseTypeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Financial.FinancialBalanceEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FinancialBalance", "financial");
                });

            modelBuilder.Entity("Domain.Entities.Financial.ManualTransactionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ManualTransaction", "financial");
                });

            modelBuilder.Entity("Domain.Entities.Financial.WalletEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 1,
                            Type = 0,
                            Uuid = new Guid("c6eccdb4-29ab-4f65-ba92-7b6580619436")
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Fiancial.FinancialReleaseEntity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Fiancial.FinancialReleaseTypeEntity", null)
                        .WithMany("FinancialReleases")
                        .HasForeignKey("FinancialReleaseTypeEntityId");
                    ...
                    b.HasOne("Domain.Entities.Financial.WalletEntity", "Wallet")
                        .WithMany()
